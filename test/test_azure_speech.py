...
speech_config = speechsdk.SpeechConfig(subscription="f8a5185d42ec403b937de9469cb3b178", region="eastasia")
...
ssml =  f"""<speak xmlns="http://www.w3.org/2001/10/synthesis" xmlns:mstts="http://www.w3.org/2001/mstts" 
        xmlns:emo="http://www.w3.org/2009/10/emotionml" version="1.0" xml:lang="zh-CN"> <voice 
        name="zh-CN-YunfengNeural"><s /> <mstts:express-as style="Default" 
        styledegree="1.0">事件在输出音频数据变为可用时引发，这样将会比播放到输出设备更快。 调用方必须相应地实时同步流式处理。</mstts:express-as> <s /></voice></speak>"""
