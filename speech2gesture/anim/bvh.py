...
def load(filename: str, start: int = None, end: int = None, order: str = None):
    channelmap = {
        'Xrotation': 'x',
        'Yrotation': 'y',
        'Zrotation': 'z'
    ...
    frame_time, names, offsets, order, parents, positions, rotations = read_line(channelmap, lines, start, end, order)
...
def read_line(channelmap: dict, lines: list, start: int = None, end: int = None, order: str = None):
    i = 0
    active = -1
    end_site = False
    state = 'definition'
    ...
    return frametime, names, offsets, order, parents, positions, rotations
