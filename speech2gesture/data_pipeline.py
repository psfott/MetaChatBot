...
from speech2gesture.anim import bvh, quat
from speech2gesture.audio.audio_files import read_wavfile, write_wavefile
from speech2gesture.audio.spectrograms import extract_mel_spectrogram_for_tts
...
def preprocess_animation(anim_data, conf=None, animation_path=None, info_df=None, i=0):
    if conf is None:
        conf = dict()
